...
#
# 1. dwml by xiilei
#    https://github.com/xiilei/dwml/blob/master/dwml/omml.py
...
#   - Replaced `defusedxml` with standard library `xml.etree.ElementTree`
#     (defusedxml is not a declared dependency of this project)
